...
public class MessageDetailActivity extends Activity {
    ...
    Button actionButton(String text, boolean primary) {
        ...
        button.setTextColor(primary ? Color.WHITE : Color.rgb(15, 77, 57));
        GradientDrawable bg = new GradientDrawable();
        bg.setColor(primary ? Color.rgb(15, 77, 57) : Color.rgb(255, 253, 248));
        bg.setCornerRadius(dp(16));
        if (!primary) bg.setStroke(dp(1), Color.rgb(231, 222, 208));
