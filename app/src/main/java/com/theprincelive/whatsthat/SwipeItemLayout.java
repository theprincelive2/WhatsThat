...
public class SwipeItemLayout extends FrameLayout {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                float dx = ev.getX() - startX;
                float newTranslationX = initialTranslationX + dx;
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (currentTranslationX > 0) {
                    // Swiped right
                    if (xVelocity > 500 || currentTranslationX > leftActionsWidth * 0.5f) {
                        targetTranslationX = leftActionsWidth;
                    }
                } else if (currentTranslationX < 0) {
                    // Swiped left
                    if (xVelocity < -500 || currentTranslationX < -rightActionsWidth * 0.5f) {
